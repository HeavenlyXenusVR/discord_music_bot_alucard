...
# lib/swarmlua/pg.lua for the bigint-precision deserializer note); secrets and
# runtime state stay in env files or mounted volumes.
COPY . .

# Start the bot
# CMD handled by compose -- exact command: luajit alucard.lua
