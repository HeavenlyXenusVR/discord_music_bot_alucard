                ...
                async with conn.cursor(aiomysql.DictCursor) as cur:
                    for g in guilds:
                        ...
                        await cur.execute(
                            ...
                            VALUES (%s, 'alucard', %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, 0, %s, %s)
                            """,
                            (
                                g.id,
                                voice_connected,
                    ...
                    async with conn.cursor() as cur:
                        ...
                        if reason == "FINISHED":
                            ...
                            if loop_mode == 'queue':
                                ...
                                await insert_queue_front(cur, "alucard_queue", guild.id, "alucard", track_uri, track_title, original_requester, track_data.get("track_uid"))
                            else:
